...
:::
::: {.fragment}
[Lists]{.py-green} can be *heterogeneous* (contain elements of different types), but **whenever possible** it’s best to keep them *homogeneous* (containing elements of the same type) for easier processing and compatibility with libraries like NumPy.
:::
...
class Cat:
    ...
    def unleash_cuteness(self):
        return print("Awwwwwwwwwww!! SOOOO CUTE!!! 😻✨💖")
