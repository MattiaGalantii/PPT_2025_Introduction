...
ax.set_ylabel(r"$\dot{\theta}$", fontsize=18)
ax.tick_params(axis='both', which='major', labelsize=14)

ax.set_title(r"Phase Space for $\dot{\theta}=\sin(\theta)$", fontsize=16)
plt.tight_layout()
plt.show()
```
...
![](assets/euler.png){alt="Euler_meme" width="400px"}
:::
