...
We’ll recover the $\lambda$ and $\omega$ parameters of a **damped sine** model from noisy synthetic data. You can open this example in a Jupyter notebook: [model_fitting.ipynb]().
...
::: {.fragment}
Now it's your turn! Open the [ode_model_fitting_exercise.ipynb]() notebook and implement the fitting of the CSTR model parameters using `least_squares` or `solve_ivp`.
:::
