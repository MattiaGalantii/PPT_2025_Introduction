...
You can open this example in a Jupyter notebook and follow me: [model_fitting_students.ipynb](https://github.com/MattiaGalantii/PPT_2025_Introduction/blob/master/lecture_exercises_students/model_fitting_students.ipynb).
...
::: {.fragment}
Now it's your turn! Open the [ode_fitting_students.ipynb](https://github.com/MattiaGalantii/PPT_2025_Introduction/blob/master/lecture_exercises_students/ode_fitting_students.ipynb) notebook and implement the fitting of the CSTR model parameters using `least_squares` and `solve_ivp`.
:::

## Solution: CSTR Model {auto-animate="true"}
You can find the solution in the [ode_fitting.ipynb](https://github.com/MattiaGalantii/PPT_2025_Introduction/blob/master/notebooks/ode_fitting.ipynb) notebook.
